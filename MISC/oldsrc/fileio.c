 ...
 *
 *	The routines in this file read and write ASCII files from
 *	the disk.  All of the knowledge about files are here.  A
 *	better message writing scheme should be used. 
 *
 *History:
 */
