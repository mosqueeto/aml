...
//#define VERSION "0.7" // from 1989
#define VERSION "0.8" // 2025-01-12 remade for modern times
...
#define A_REST      0
#define NOTE_ON     0x90    /* midi event */
#define NOTE_OFF    0x80    /* midi event */
#define A_NOTE      3
#define START_TIE   4
#define END_TIE     5
#define UNDEFINED   15
...
int song_volume = 64; /* the default value that is  */
